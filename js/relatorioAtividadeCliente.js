$("#document").ready(function(){ 
  ...
  $("#formRelatorioAtividadesClientes #btnCancelar").click(function(){
...
function gerarRelatorio(txbDatIni, txbDatFin, txbConsultor, txbCliente){
  ...
  nmRelatorio = "ExtratoAtividadeCliente_" + dataAtual() + '_' +  horaAtual();
  ...
  $.ajax({
      ...
      url: "../../phpjasper/vendor/geekcom/phpjasper/templates/ExtratoAtividadeCliente.php",

      //Se der tudo ok no envio...
      success: function (dados) {
        downLoadAtividadeCliente(nmRelatorio);
      }
    });

}

function downLoadAtividadeCliente(nmRelatorio){
