            ...
            <form id="formGeral" class="form-horizontal" role="form">
              <div class="form-group">
                <div class="col-md-2">
                  ...
                  <input id="txbUsuario" type="text" class="form-control" name="txbUsuario" value="<?php echo ucfirst($_SESSION["nomUsu"]); echo " " . ucfirst($_SESSION["sobrenomeUsu"]) ?>" readonly ></input>
                </div>
                <div class="col-md-2">
